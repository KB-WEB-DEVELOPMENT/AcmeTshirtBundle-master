<?php
namespace Acme\TshirtBundle\Tests\Selenium;
...
abstract class AbstractSeleniumTest extends \PHPUnit_Extensions_SeleniumTestCase //WebTestCase
{
    ...
    protected function setUp()
    {
        ...
        $application->run(new ArrayInput(array('command' => 'doctrine:data:load', '--fixtures' => 'src/Acme/TshirtBundle/DataFixtures/ORM/')));
